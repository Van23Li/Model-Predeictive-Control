classdef NmpcControl < handle
    ...
    methods
        function obj = NmpcControl(rocket, tf)
            ...
            % set lbx, ubx, lbu, ubu defined above
            ubx(5,1 ) = deg2rad(80);
            lbx(5,1 ) = -deg2rad(80);
            ubu(1,1 ) = deg2rad(15);
            lbu(1,1 ) = -deg2rad(15);
            ...
            % get terminal cost
            [xs, us] = rocket.trim(); % ref pose is vertical to ground
            ...
            Q = diag([25;25;25;10;10;10;10;10;35;70;70;100]);
            R = eye(nu)*0.001;
