...
[ur, T_optr, X_optr, U_optr] = mpc_r.get_u(x0(idx{4}));
U_optr(:,end+1) = nan;
phr = rocket.plotvis_sub(T_optr, X_optr, U_optr, sys_roll, xs, us); % Plot as usual
sgtitle("Controller of Roll-openloop");
[Tr, R_subr, U_subr] = rocket.simulate_f(sys_roll, x0(idx{4}), Tf, @mpc_r.get_u, 0);
